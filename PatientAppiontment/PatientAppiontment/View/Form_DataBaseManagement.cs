    ...
    public partial class Form_DataBaseManagement : Form
    {
        ...
        private void btn_IsDataBaseExist_Appiontment_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                btn_CreateDataBase_Appiontment.Enabled = true;
            }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btn_CreateDataBase_Appiontment_Click(object sender, EventArgs e)
        {
            ...
            if (!(Result_CreateDataBase.result == Result.Success))
            {
                ...
                btn_IsDataBaseExist_Appiontment_Click(sender, e);
            }
        }
    }
}
